...
public class GreedyTravelPlanner {
    ...
    public Result planIntelligentRoute(Graph graph, City start, City end, List<City> allCities) {
        ...
        String description = generateRouteDescription(start, end, suggestedCities, directDistance, totalDistance,
                shortestDistance);
    ...
    /**
     * Dijkstra's algorithm implementation for finding shortest path between two
     * cities
     */
    private DijkstraResult dijkstra(Graph graph, City start, City end) {
        ...
        // If destination unreachable, return empty path and infinite distance
        double endDistance = distances.getOrDefault(end, Double.POSITIVE_INFINITY);
        if (endDistance == Double.POSITIVE_INFINITY) {
        ...
        return new DijkstraResult(path, endDistance);
    }
    ...
    private double calculatePathDeviation(City start, City end, City city) {
        ...
        // Simple approximation: if the city is very close to start or end, deviation is
        // small
        ...
        // If the sum of distances to start and end is close to direct distance, city is
        // on the path
     ...
     * This method is necessary for advanced route planning and may be used by other
     * planners or future features.
     */
    private List<City> buildOptimalRouteWithDijkstra(Graph graph, City start, City end, List<City> suggestedCities,
    ...
    private double shortestEdgeDistance(Graph graph, City from, City to) {
        // In this simple model we assume direct edge exists; else approximate by
        // Haversine.
